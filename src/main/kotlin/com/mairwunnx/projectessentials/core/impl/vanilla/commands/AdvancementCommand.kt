...
internal object AdvancementCommand : VanillaCommandBase() {
    val aliases = configuration.take().aliases.advancement + "advancement"
    ...
    fun register(dispatcher: CommandDispatcher<CommandSource>) {
        CommandAPI.removeCommand("advancement")
        tryAssignAliases()
                    ...
                    Commands.literal("grant").then(
                        Commands.argument(
                            ...
                            Commands.literal("only").then(
                                Commands.argument(
                                    "advancement", ResourceLocationArgument.resourceLocation()
                                    ...
                                    Commands.argument(
                                        "criterion", StringArgumentType.greedyString()
                                    ).suggests { p_198209_0_, p_198209_1_ ->
                                        ISuggestionProvider.suggest(
                                            ResourceLocationArgument.getAdvancement(
                                                p_198209_0_, "advancement"
            ...
            if (advancements.size == 1) {
                if (targets.size == 1) {
                    ...
                    throw CommandException(
                        TranslationTextComponent(
                            ...
                            advancements.iterator().next().displayText, targets.size
                        )
                    )
                }
                ...
                throw CommandException(
                    TranslationTextComponent(
                        ...
                        advancements.size, targets.iterator().next().displayName
                    )
                )
            } else {
                throw CommandException(
                    TranslationTextComponent(
                        ...
                        advancements.size, targets.size
                    )
                )
            }
        } else {
        ...
        return if (!advancementIn.criteria.containsKey(criterionName)) {
            throw CommandException(
                TranslationTextComponent(
                    ...
                    advancementIn.displayText, criterionName
                )
            )
        } else {
            for (serverplayerentity in targets) {
                ...
                if (targets.size == 1) {
                    ...
                    throw CommandException(
                        TranslationTextComponent(
                            ...
                            criterionName, advancementIn.displayText, targets.size
                        )
                    )
                }
            } else {
